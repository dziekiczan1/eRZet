      ...
      >
        ...
        >
          <div
            className={
              theme === "dark"
                ? "bg-navy-700 rounded-full w-[60px] h-[60px] flex justify-center items-center shadow-md"
                : "bg-light-100 rounded-full w-[60px] h-[60px] flex justify-center items-center shadow-md"
            }
          >
            <svg
              width="16"
