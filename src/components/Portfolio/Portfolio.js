      ...
      >
        ...
        >
          <div
            className={
              theme === "dark"
                ? "bg-navy-700 rounded-full w-[30px] h-[30px] md:w-[60px] md:h-[60px] flex justify-center items-center shadow-md"
                : "bg-light-100 rounded-full w-[30px] h-[30px] md:w-[60px] md:h-[60px] flex justify-center items-center shadow-md"
            }
          >
            <svg
              viewBox="0 0 8 13"
              ...
              className="relative right-[2px] w-[12px] h-[18px] md:w-[16px] md:h-[26px]"
            >
              <path
        ...
        >
          ...
          >
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="relative left-[2px] w-[12px] h-[18px] md:w-[16px] md:h-[26px]"
            >
              <path
