...
function Button({ className, appearance, children }) {
  const styles = {
    base: "flex flex-row items-center justify-center gap-2 uppercase bg-navy-700 p-2 md:p-4 text-white text-bold outline-offset-4 outline outline-2 outline-orange-100",
  };
